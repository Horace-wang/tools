...
import com.horace.tool.entity.LeetCodeEntity;
...
public class LeetCodeService {
    ...
    public LeetCodeEntity getLeetCodeTodayFirst() {
        ...
        LeetCodeEntity leetCode = new LeetCodeEntity();
    ...
    public String insertRedis() {
        LeetCodeEntity first = getLeetCodeTodayFirst();
